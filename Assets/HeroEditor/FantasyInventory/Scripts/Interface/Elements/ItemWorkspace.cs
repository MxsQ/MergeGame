...
namespace Assets.HeroEditor.FantasyInventory.Scripts.Interface.Elements
{
    ...
    public abstract class ItemWorkspace : MonoBehaviour
    {
        ...
        {
            itemCollection.GeneratedItems = new List<ItemParams> { new ItemParams { Id = "FantasyHeroes.Basic.Supplies.Gold", Type = ItemType.Currency, Path = "Assets/HeroEditor/FantasyHeroes/Icons/WithoutBackground/Equipment/Supplies/Basic/Currency/Gold.png" } };

            for (var i = 0; i < 5; i++)
            {
                var helmet = new ItemParams
                {
                    Id = spriteCollection.Helmet[i].Id,
                ...
                {
                    Id = spriteCollection.Armor[i].Id,
                    Type = ItemType.Armor,
                    Price = i,
                    Properties = new List<Property> { new Property(PropertyId.Resistance, i) },
                ...
                {
                    Id = spriteCollection.MeleeWeapon1H[i].Id,
                ...
                {
                    Id = spriteCollection.Shield[i].Id,
