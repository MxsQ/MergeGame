...
namespace Assets.HeroEditor.Common.CommonScripts
{
    ...
    public static class Extensions
    {
        ...
        public static Sprite FindSpriteByPath(this List<SpriteGroupEntry> list, string path)
        {
            return list.SingleOrDefault(i => i.Path == path)?.Sprite;
        }

        public static List<Sprite> FindSpritesByPath(this List<SpriteGroupEntry> list, string path)
        {
